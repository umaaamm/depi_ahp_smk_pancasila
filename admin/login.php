...
<head>
  ...
  <title>Website Pendaftaran SMK Pancasila | Log in</title>
...
<div class="login-box">
  ...
  <?php
        if(isset($_POST['login']))
        {
            ...
            $querylogin=$koneksi->query("select username,password,level from tbl_admin where username='".$username."' and password='".$password."'" );
