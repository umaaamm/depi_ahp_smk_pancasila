...
<div class="col-md-12">
    <div class="box box-primary">
            ...
            <div class="box-body">
    Jika CR = 0, maka Matriks Perbandingan <b>KONSISTEN</b> <br>
    Jika CR =< 0.1, maka Matriks Perbandingan <b>CUKUP KONSISTEN</b> <br>
    Jika CR >0.1, maka Matriks Perbandingan <b>SANGAT TIDAK KONSISTEN</b> <br><br>
    Nilai CR = <b> <?php echo ci(); ?></b>
    <br><br>
    <table class="table table-bordered table-striped" id="l3">
            <thead>
        <?php
