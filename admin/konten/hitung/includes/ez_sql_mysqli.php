...
class ezSQL_mysqli extends ezSQLcore
{
    ...
    function ezSQL_mysqli($dbuser = 'root', $dbpassword = '', $dbname = 'umat5452_yoel', $dbhost = 'localhost', $encoding = '')
    {
        $this->dbuser = $dbuser;
    ...
    function quick_connect($dbuser = 'root', $dbpassword = '', $dbname = 'umat5452_yoel', $dbhost = 'localhost', $dbport = '3306', $encoding = '')
    {
        $return_val = false;
    ...
    function select($dbname = 'umat5452_yoel', $encoding = '')
    {
        global $ezsql_mysqli_str;
        $return_val = false;
